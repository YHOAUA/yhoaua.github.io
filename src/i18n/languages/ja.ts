...
export const ja: Translation = {
	...
	[Key.projectsCategoriesCount]: "カテゴリ数",
	[Key.projectsEmpty]: "まだプロジェクトはありません",
	[Key.projectsEmptyDescription]:
		"プロジェクトを追加すると、ここに自動で表示されます。",
	[Key.projectsViewDemo]: "デモを見る",
	[Key.projectsViewRepo]: "リポジトリを見る",
	[Key.projectsCategoryWorks]: "作品",
	[Key.projectsCategoryOpenSource]: "オープンソース",
	[Key.projectsCategoryPractice]: "練習",
	[Key.projectsStatusActive]: "進行中",
	[Key.projectsStatusMaintained]: "保守中",
	[Key.projectsStatusArchived]: "アーカイブ済み",
	[Key.untitled]: "無題",
