...
export const zh_TW: Translation = {
	...
	[Key.news]: "新聞",
	[Key.newsDescription]:
		"聚合不同來源的熱門新聞與討論，目前接入中國熱榜和 Hacker News。",
	[Key.newsCategoryChina]: "中國熱榜",
	[Key.newsCategoryHackerNews]: "Hacker News",
	[Key.newsCategoryWorldNews]: "國外新聞",
	[Key.newsLatestUpdated]: "來源更新時間",
	[Key.newsOpenSource]: "打開來源站",
	[Key.newsItems]: "條內容",
	[Key.newsSources]: "個來源",
	[Key.newsEmpty]: "暫無新聞內容",
	[Key.newsEmptyDescription]: "當前分類沒有可展示的資料，稍後重試或直接打開來源站查看。",
	[Key.newsSnapshotHint]:
		"本頁會在瀏覽器中即時拉取內容，點擊卡片或來源站按鈕可查看完整頁面。",
	[Key.newsRefresh]: "立即重新整理",
	[Key.newsRefreshing]: "重新整理中...",
	[Key.newsLastRefreshed]: "本頁更新於",
	...
	[Key.projectsCategoriesCount]: "分類數量",
	[Key.projectsEmpty]: "還沒有項目",
	[Key.projectsEmptyDescription]:
		"添加項目內容後，這裡會自動顯示你的項目卡片。",
	[Key.projectsViewDemo]: "查看演示",
	[Key.projectsViewRepo]: "查看倉庫",
	[Key.projectsCategoryWorks]: "作品",
	[Key.projectsCategoryOpenSource]: "開源",
	[Key.projectsCategoryPractice]: "練習",
	[Key.projectsStatusActive]: "進行中",
	[Key.projectsStatusMaintained]: "維護中",
	[Key.projectsStatusArchived]: "已封存",
	[Key.untitled]: "無標題",
