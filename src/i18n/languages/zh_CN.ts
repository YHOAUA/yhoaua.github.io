...
export const zh_CN: Translation = {
	...
	[Key.news]: "新闻",
	[Key.newsDescription]:
		"聚合不同来源的热门新闻与讨论，目前接入中国热榜和 Hacker News。",
	[Key.newsCategoryChina]: "中国热榜",
	[Key.newsCategoryHackerNews]: "Hacker News",
	[Key.newsCategoryWorldNews]: "国外新闻",
	[Key.newsLatestUpdated]: "源更新时间",
	[Key.newsOpenSource]: "打开源站",
	[Key.newsItems]: "条内容",
	[Key.newsSources]: "个来源",
	[Key.newsEmpty]: "暂无新闻内容",
	[Key.newsEmptyDescription]: "当前分类没有可展示的数据，稍后重试或直接打开源站查看。",
	[Key.newsSnapshotHint]:
		"本页会在浏览器中实时拉取内容，点击卡片或源站按钮可查看完整页面。",
	[Key.newsRefresh]: "立即刷新",
	[Key.newsRefreshing]: "刷新中...",
	[Key.newsLastRefreshed]: "本页刷新于",
	[Key.newsAutoRefresh]: "自动刷新间隔",
	...
	[Key.projectsCategoriesCount]: "分类数量",
	[Key.projectsEmpty]: "还没有项目",
	[Key.projectsEmptyDescription]:
		"添加项目内容后，这里会自动显示你的项目卡片。",
	[Key.projectsViewDemo]: "查看演示",
	[Key.projectsViewRepo]: "查看仓库",
	[Key.projectsCategoryWorks]: "作品",
	[Key.projectsCategoryOpenSource]: "开源",
	[Key.projectsCategoryPractice]: "练习",
	[Key.projectsStatusActive]: "进行中",
	[Key.projectsStatusMaintained]: "维护中",
	[Key.projectsStatusArchived]: "已归档",
	[Key.untitled]: "无标题",
