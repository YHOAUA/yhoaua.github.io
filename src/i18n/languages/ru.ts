...
export const ru: Translation = {
	...
	[Key.projectsCategoriesCount]: "Категории",
	[Key.projectsEmpty]: "Пока нет проектов",
	[Key.projectsEmptyDescription]:
		"Добавьте проекты, и они автоматически появятся здесь.",
	[Key.projectsViewDemo]: "Открыть демо",
	[Key.projectsViewRepo]: "Открыть репозиторий",
	[Key.projectsCategoryWorks]: "Работы",
	[Key.projectsCategoryOpenSource]: "Open Source",
	[Key.projectsCategoryPractice]: "Практика",
	[Key.projectsStatusActive]: "В работе",
	[Key.projectsStatusMaintained]: "Поддерживается",
	[Key.projectsStatusArchived]: "В архиве",
